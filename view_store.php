...
<div class="col-lg-12">
    ...
    <div class="panel-heading">
        ...
        <i class="fa fa-tags"></i> View Store
       </div>
        ...
        <div class="table-responsive">
            ...
            <tbody><?php
                $i=0;
                $get_pro ="select * from store order by 1 DESC";
                ...
                <td>
                   <a href="index.php?edit_store=<?php echo $pro_id;?>" target="_blank">
                ...
                <script>
                 function deleteme(delid){
                     if(confirm("Are you sure you want to delete?")){
                         window.location.href='delete_store.php?delete_product=' +delid+'';
                         return true;
                     }
                 }
