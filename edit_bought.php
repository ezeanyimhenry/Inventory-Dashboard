...
if(isset($_GET['edit_bought'])){
    $edit_id = $_GET['edit_bought'];
    $get_p = "select * from bought where b_id='$edit_id'";
    $run_edit = mysqli_query($con,$get_p);
    $row_edit = mysqli_fetch_array($run_edit);
    $p_id = $row_edit['b_id'];
    $p_cat = $row_edit['b_color'];
    $p_name = $row_edit['b_name'];
    $quan = $row_edit['b_quantity'];
...
if(isset($_POST['update'])){
   $product_title = mysqli_real_escape_string($con,$_POST['product_title']);
    ...
    $quantity = mysqli_real_escape_string($con,$_POST['quantity']);
             ...
             $sql= "UPDATE bought SET b_name='$product_title',b_color='$product_cat',unit_price='$initial_prices',b_quantity='$quantity' WHERE b_id='$p_id'";
