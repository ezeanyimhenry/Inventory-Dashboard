...
if(isset($_GET['edit_cats'])){
    ...
    $get_p = "select * from colors where id='$edit_id'";
...
if(isset($_POST['update'])){
   $product_title = mysqli_real_escape_string($con,$_POST['product_title']);
             ...
             $sql= "UPDATE colors SET color='$product_title' WHERE id='$p_id'";
...
?>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><i class="fa fa-pencil fa-fw"></i>Update Category</h3>
