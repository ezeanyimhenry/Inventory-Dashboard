...
if(isset($_POST['submit'])){
   $product_title = mysqli_real_escape_string($con,$_POST['product_title']);
    ...
    $quantity = mysqli_real_escape_string($con,$_POST['quantity']);
         ...
         mysqli_query($con, "insert into bought (b_name,b_quantity,b_color,unit_price) values ('$product_title','$quantity','$product_cat', '$initial_price')");
    
    $sql = "SELECT b_quantity FROM bought WHERE b_quantity = $quantity";
    $run = mysqli_query($con, $sql);
    $fetch = mysqli_fetch_assoc($run);
    $quantity = $fetch['b_quantity'];
