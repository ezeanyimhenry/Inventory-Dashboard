...
<body id="body">
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="sold.html">Sell Product </a></li>
          <li class="menu-active"><a href="bought.html">Buy Product </a></li>
          <li><a href="display.html">Display Stock </a></li>
        </ul>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2> Add Bought Product</h2>
     
      <h4>Enter product details here to add to the database. </h4>
      <div>
        <form method="POST">
        <select name= "product" class="input-txt" required="required">
             ...
             <select name="color" class="input-txt" required="required">
        ...
        <input type="" name="amount" class="input-txt" required="required" placeholder="AMOUNT">
        <button type="submit" class="btn-projects scrollto" name="submit" >Add Product</button>
        </form>
      </div>
      <?php
      if(isset($msg)){
...
$sql="INSERT INTO nametable (product, color, amount)

VALUES

('$_POST[product]','$_POST[color]','$_POST[amount]')";
