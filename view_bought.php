...
<div class="col-lg-12">
    ...
    <div class="panel-heading">
        ...
        <i class="fa fa-tags"></i> View Bought
        </h3>
       </div>
        ...
        <div class="table-responsive">
            ...
            <tbody><?php
                $i=0;
                $get_pro ="select * from bought order by 1 DESC";
                $run_pro = mysqli_query($con,$get_pro);
                
                while($row_pro=mysqli_fetch_array($run_pro)){
                  $pro_id = $row_pro['b_id'];
                    $pro_name = $row_pro['b_name'];
                    $pro_price = $row_pro['unit_price'];
                    $pro_keywords = $row_pro['b_quantity'];
                    $pro_desc = $row_pro['b_color'];
                    $date = $row_pro['date'];
                ...
                <td>
                   <a href="index.php?edit_bought=<?php echo $pro_id;?>">
                ...
                <script>
                 function deleteme(delid){
                     if(confirm("Are you sure you want to delete?")){
                         window.location.href='index.php?delete_bought=' +delid+'';
                         return true;
                     }
                 }
